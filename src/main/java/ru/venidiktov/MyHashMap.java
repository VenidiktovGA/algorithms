...
public class MyHashMap {
     ...
     * Если изменять размер не на фиксированное количество элементов, а в несколько раз, то это позволяет достичь
     * амортизированного времени влияния увеличения или уменьшения массива с копированием на всю работу
     * 1 + 2 + 4 + 8 + ... + N/2 < 2N
